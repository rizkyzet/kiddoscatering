...
class Laporan extends CI_Controller
{
    ...
    //     $this->load->view('pemilik/laporan/siswa');
    ...
    public function laporan_pemesanan($id_sekolah)
    {
        ...
        $this->load->view('templates_stisla_dashboard/navbar');
        $this->load->view('templates_stisla_dashboard/sidebar_pemilik');
        $this->load->view('pemilik/laporan/laporan_pemesanan');
        $this->load->view('templates_stisla_dashboard/footer');
    }
    ...
    public function cetak_lap_pemesanan()
    {
        ...
        $html = $this->load->view('pemilik/laporan/cetak_lap_pemesanan', $data, true);
    ...
    public function laporan_pendapatan($id_sekolah)
    {
        ...
        $this->load->view('templates_stisla_dashboard/navbar');
        $this->load->view('templates_stisla_dashboard/sidebar_pemilik');
        $this->load->view('pemilik/laporan/laporan_pendapatan');
        $this->load->view('templates_stisla_dashboard/footer');
    }
    ...
    public function cetak_lap_pendapatan()
    {
        ...
        $html = $this->load->view('pemilik/laporan/cetak_lap_pendapatan', $data, true);
